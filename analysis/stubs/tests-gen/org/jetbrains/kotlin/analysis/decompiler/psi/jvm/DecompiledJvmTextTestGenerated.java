...
public class DecompiledJvmTextTestGenerated extends AbstractDecompiledJvmTextTest {
  @Test
  ...
  public class K1 {
    ...
    public void testAllFilesPresentInK1() {
      KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/psi/k1"), Pattern.compile("^([^.]+)\\.kt$"), null, true);
    }
