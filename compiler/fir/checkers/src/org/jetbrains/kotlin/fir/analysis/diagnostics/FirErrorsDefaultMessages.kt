...
import org.jetbrains.kotlin.fir.analysis.diagnostics.FirErrors.IMPLICIT_PROPERTY_TYPE_ON_INVOKE_LIKE_CALL
...
//            map.put(UNKNOWN_CALLABLE_KIND, ...) // &
        ...
        map.put(
            IMPLICIT_PROPERTY_TYPE_ON_INVOKE_LIKE_CALL,
            "The resolving behavior is flaky and dependents on declarations order. Please specify the return type of the ''{0}'' property explicitly.",
            SYMBOL,
        )
        map.put(
