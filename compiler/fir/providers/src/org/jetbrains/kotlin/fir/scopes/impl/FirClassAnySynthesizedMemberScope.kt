 ...
 *
 * Although the underlying data class likely has source-based symbol IDs, the symbol IDs of synthetic elements generated by this scope are
 * allowed to be unique because they're stored in a session-wide cache.
 */
class FirClassAnySynthesizedMemberScope(
    ...
    private fun generateEqualsFunction(): FirNamedFunction =
        buildNamedFunction {
            ...
            // TODO (marco): This usage of `source` technically means we have a duplicate fake source element. But the type ref is not a
            //  FIR declaration, so should this be legal?
            ...
            this.valueParameters.add(
                buildValueParameter {
                    ...
                    // The symbol is allowed to be unique since the owning function is cached in a session component.
    ...
    private fun FirNamedFunctionBuilder.generateSyntheticFunction(
        ...
        // The symbol is allowed to be unique since the synthetic function is cached in a session component.
