...
class ConeSkippedPropertyWithImplicitTypeWhenResolvingInvokeCallWithExtensionReceiver(val property: FirPropertySymbol) : ConeDiagnostic {
    override val reason: String
        get() = "The $property candidate is skipped because it has implicit return type."
}