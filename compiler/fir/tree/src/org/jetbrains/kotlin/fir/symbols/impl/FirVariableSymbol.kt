...
) : FirVariableSymbol<FirValueParameter>(symbolId),
...
) : FirBasedSymbol<FirReceiverParameter>(symbolId), FirThisOwnerSymbol<FirReceiverParameter> {
    /**
...
) : FirPropertySymbol(symbolId), FirErrorCallableSymbol<FirProperty> {
