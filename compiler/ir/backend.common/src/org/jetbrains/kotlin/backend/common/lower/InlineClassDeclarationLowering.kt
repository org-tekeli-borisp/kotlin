...
class InlineClassDeclarationLowering(private val context: CommonBackendContext) : DeclarationTransformer {
...
// This annotation must be placed here, but it is hard to achieve because this lowering is in a common module, while lowering is from JS.
