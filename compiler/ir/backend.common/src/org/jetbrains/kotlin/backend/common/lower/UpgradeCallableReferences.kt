        ...
        private fun IrCallableReference<*>.wrapFunction(
            ...
            return buildWrapperFunction(
                ...
                val forwardOrder = buildList {
                    ...
                    require(unboundIndex == parameters.size) {
                        "Wrong number of unbound parameters in wrapper: expected:${unboundIndex - captured.size} unbound, but ${parameters.size - captured.size} found"
                    }
                }
