...
fun main3() {
    val x = <!UPPER_BOUND_VIOLATED_IN_TYPEALIAS_EXPANSION!>A3<Int?>()<!> // TODO: support reporting errors on typealias constructor calls
    val x2 = A<<!UPPER_BOUND_VIOLATED_IN_TYPEALIAS_EXPANSION!>Int?<!>>() // TODO: support reporting errors on typealias constructor calls
    val y: <!UPPER_BOUND_VIOLATED_IN_TYPEALIAS_EXPANSION!>A3<Int?><!> = <!UPPER_BOUND_VIOLATED_IN_TYPEALIAS_EXPANSION!>A3<Int?>()<!>
}
