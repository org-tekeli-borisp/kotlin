...
enum class LanguageFeature(
    ...
    ProperlyCheckUpperBoundsViolationsWhenCreatingFreshVariables(KOTLIN_2_4, enabledInProgressiveMode = true, "KTLC-373"),
    ...
    DisableMaxTypeDepthFromInitialConstraints(sinceVersion = KOTLIN_2_4, enabledInProgressiveMode = true, "KT-81441"),
