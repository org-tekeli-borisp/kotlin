...
internal abstract class KotlinKProperty<out V>(
    ...
    private val _allParameters = ReflectProperties.lazySoft {
        computeParameters(
    ...
    override val annotations: List<Annotation>
        get() {
            ...
            val syntheticMethod = kmProperty.syntheticMethodForAnnotations
                ?: throw KotlinReflectionInternalError("No synthetic method signature found: $this")
            ...
            return annotations.unwrapRepeatableAnnotations()
        }
    ...
    abstract class Accessor<out PropertyType, out ReturnType> :
        ...
        override val annotations: List<Annotation>
            get() =
                ...
                else (caller.member as? Method)?.annotations?.toList().orEmpty().unwrapRepeatableAnnotations()
    }
