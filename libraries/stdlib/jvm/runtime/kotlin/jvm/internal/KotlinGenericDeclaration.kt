...
/**
 * Common superinterface for Kotlin reflection objects which can have type parameters, and which provide a method [findJvmDeclaration]
 * to find the corresponding Java reflection object.
 */
// TODO(review): KTypeParameterOwner?
public interface KotlinGenericDeclaration {
     ...
     */
    public fun findJvmDeclaration(): GenericDeclaration?
}
